...
## 있으면 utils/create_split_dir.pl 실행 _corpus_에 storage 만들기..
...
## 1~nj까지 
## utils/create_data_link.pl : _corpus_/storage 꼭 존재해야함
## egs/egs.3.4.ark -> storage/4/egs.3.4.ark 처럼 랜덤하게 숫자 정해서 생성
